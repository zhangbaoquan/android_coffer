...
import com.global.coffer.map.view.DrawingViewV2

class DrawMapActivityV2 : AppCompatActivity() {

    private var currentStatus: DrawState = DrawState.Default

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_draw_map_v2_main)
        val drawingView = findViewById<DrawingViewV2>(R.id.drawing_view)
        ...
        findViewById<AppCompatButton>(R.id.b3).setOnClickListener({
